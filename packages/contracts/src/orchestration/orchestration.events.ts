...
import {
  ...
  ThreadQueuedPromptFlushCancelledPayload,
...
export const OrchestrationEvent = Schema.Union([
  ...
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("thread.queued-prompt-flush-cancelled"),
    payload: ThreadQueuedPromptFlushCancelledPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
  ...
  Schema.Struct({
    ...
    payload: ThreadTurnControlSetPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
