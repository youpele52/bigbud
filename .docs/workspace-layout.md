...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@bigbud/shared/git`, `@bigbud/shared/DrainableWorker`) — no barrel index.
