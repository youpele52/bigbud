...
<Section padding="80px 32px" background="var(--alc-bg-nav)" id="hot-reload">
  <div style="text-align:center;margin-bottom:32px;">
    ...
    <p style="font-size:15.5px;line-height:1.6;color:var(--alc-fg-2);max-width:680px;margin:0 auto;">
      Vite, Astro, TanStack, SolidStart — frontend, backend, and infra hot-reload together against real R2 / KV / D1. <a class="alc-learn-more" href="/concepts/local-development">Learn more &rarr;</a>
    </p>
  </div>
