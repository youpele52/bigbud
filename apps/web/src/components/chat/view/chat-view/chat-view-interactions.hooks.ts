...
export function useChatViewInteractions({
  ...
  const planHandlers = usePlanHandlers({
    ...
    planCardDismissedForTurnRef: base.planCardDismissedForTurnRef,
    planCardOpenOnNextThreadRef: base.planCardOpenOnNextThreadRef,
    ...
    setPlanCardOpen: base.setPlanCardOpen,
