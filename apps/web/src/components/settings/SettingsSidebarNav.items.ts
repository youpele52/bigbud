...
export const SETTINGS_SEARCH_ITEMS: ReadonlyArray<{
  ...
  { label: "New threads", section: "General", to: "/settings/general" },
  { label: "Archive confirmation", section: "General", to: "/settings/general" },
  { label: "Delete confirmation", section: "General", to: "/settings/general" },
  { label: "Automatic thread cleanup", section: "General", to: "/settings/general" },
  { label: "Automatically delete old threads", section: "General", to: "/settings/general" },
  { label: "Delete eligible threads now", section: "General", to: "/settings/general" },
