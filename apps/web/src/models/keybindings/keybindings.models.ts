...
import type { ShortcutEventLike, ShortcutMatchContext } from "./keybindings.models.types";

export type { ShortcutEventLike, ShortcutMatchContext } from "./keybindings.models.types";
export {
  isTerminalClearShortcut,
  terminalDeleteShortcutData,
  terminalNavigationShortcutData,
} from "./keybindings.models.terminal";
...
function eventCodeLetterAlias(code: string | undefined): string | null {
...
function resolveEventKeys(event: ShortcutEventLike): Set<string> {
  ...
  const letterAlias = eventCodeLetterAlias(event.code);
  if (letterAlias) {
    keys.add(letterAlias);
  }
...
export function isGitToggleShortcut(
  event: ShortcutEventLike,
  keybindings: ResolvedKeybindingsConfig,
  options?: ShortcutMatchOptions,
): boolean {
  return matchesCommandShortcut(event, keybindings, "git.toggle", options);
}
...
export function isNotesToggleShortcut(
  event: ShortcutEventLike,
  keybindings: ResolvedKeybindingsConfig,
  options?: ShortcutMatchOptions,
): boolean {
  return matchesCommandShortcut(event, keybindings, "notes.toggle", options);
}

export function isProjectOpenShortcut(
  event: ShortcutEventLike,
  keybindings: ResolvedKeybindingsConfig,
  options?: ShortcutMatchOptions,
): boolean {
  return matchesCommandShortcut(event, keybindings, "project.open", options);
}
