/**
 * Per-thread state transition helpers for the terminal Zustand store.
 *
 * All functions here are pure state transitions operating on
 * ThreadTerminalState — no store references.
 *
 * @module helpers.transitions.store
 */

import { DEFAULT_THREAD_TERMINAL_ID, MAX_TERMINALS_PER_GROUP } from "../../models/types";

import type { ThreadTerminalState } from "./helpers.store";
import {
