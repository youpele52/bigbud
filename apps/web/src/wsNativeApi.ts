...
export function createWsNativeApi(): NativeApi {
  ...
  const api: NativeApi = {
    ...
    git: {
      ...
      generateBranchName: (input) => transport.request(WS_METHODS.gitGenerateBranchName, input),
      generateAndRenameBranch: (input) =>
        transport.request(WS_METHODS.gitGenerateAndRenameBranch, input),
