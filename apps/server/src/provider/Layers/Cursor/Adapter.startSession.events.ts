...
interface CursorStartSessionEventDeps {
...
export function logNative(
  deps: Pick<CursorStartSessionEventDeps, "nativeEventLogger">,
  threadId: ThreadId,
  method: string,
  payload: unknown,
) {
...
export function emitPlanUpdate(
  deps: Pick<CursorStartSessionEventDeps, "makeEventStamp" | "offerRuntimeEvent">,
