/**
 * DevinAdapter types and internal helpers.
 *
 * @module DevinAdapter.types
 */
...
export interface DevinEventStamp {
...
export function parseDevinResume(raw: unknown): { sessionId: string } | undefined {
