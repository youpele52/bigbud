...
import { resultErrorsText, isInterruptedResult } from "./Adapter.utils.ts";
...
export function streamKindFromDeltaType(
  deltaType: string,
): import("./Adapter.types.ts").ClaudeTextStreamKind {
...
): import("./Adapter.types.ts").ClaudeToolResultStreamKind | undefined {
  switch (itemType) {
